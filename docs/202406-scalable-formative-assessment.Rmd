...
# First Slide $\approx$ Whole Talk

>- "short-answer" tasks are good for students, but hard to scale  
>- Can NLP tools support instructors with student feedback?  
>    - How much / what kind of support is needed?  
>    - Are tools reliable enough to actually help instructors?  
>    - Scalable, personalized feedback: difficult but possible  
>- NLP tools performed as well a typical teaching team at marking  
>- Feedback is more complex, and we're currently exploring a few alternatives  
...
<!-- Note: as a statistician, I'm always comparing current circumstances of my data to some ideal state and negotiating compromise to achieve most desirable outcomes possible given the circumstances available. It's the same here--we want to create useful FA where there is (almost) none-->
...
- Answer-state Recurrent Relational Network  
    - (AsRRN; Li, Lloyd, Beckman, & Passonneau, 2023)  
